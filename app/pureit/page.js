...
const faqs = [
  { q: 'Do you provide Pureit service at home in Pune?', a: 'Yes! We provide doorstep Pureit RO water purifier service across all areas of Pune and Pimpri-Chinchwad. Same-day slots available.' },
  { q: 'How much does Pureit RO service cost in Pune?', a: 'Basic Pureit RO service starts from ₹299. Filter change, membrane replacement, and repair costs vary by model. We give a transparent estimate before starting.' },
  { q: 'How often should I service my Pureit water purifier?', a: "We recommend servicing your Pureit RO every 6 months. Pune's hard water can clog filters faster. Annual Maintenance Contracts (AMC) are also available." },
  { q: 'Do you use genuine Pureit spare parts?', a: 'Yes, we use only genuine or high-quality compatible parts for Pureit RO purifiers — filters, membranes, pumps and more.' }
];
